                    ...
                    <div class="control-speed">
                        ...
                        <div>
                            <div id="device-led-btn">
                                <label><button name="speedbtn" class="small-btn" onclick="ledCtrl(1);">IO1</button></label>
                                <label><button name="speedbtn" class="small-btn" onclick="ledCtrl(2);">IO2</button></label>
        ...
        <section>
            ...
            <div class="fb-input-info">
                ...
                <div class="info-box json-cmd-info">
                    ...
                    <div>
                        <p>SPEED_CTRL: <span id="cmd1" class="cmd-value">{"T":1,"L":200,"R":200}</span></p>
                ...
                <div class="info-box json-cmd-info">
                    <div>
                        <p>CMD_LED_CTRL: <span id="cmd132" class="cmd-value">{"T":132,"IO1":255,"IO2":255}</span></p>
