...
void setup() {
  ...
  Serial2.begin(38400, SERIAL_8N1, DDSM_RX, DDSM_TX);
  while(!Serial2) {}
 

  // dc.ddsm_ctrl(1, 1000, 1);
  // delay(10);
  // dc.ddsm_ctrl(2, -1000, 1);
  // delay(10);
  // dc.ddsm_ctrl(3, -1000, 1);
  // delay(10);
  // dc.ddsm_ctrl(4, 1000, 1);
  // delay(10);
...
// Serial.println("http & web init.");
  ...
  ddsm_ctrl_loop();
  if (baseFeedbackFlow==1) {
    baseInfoFeedback();
  }
 if (baseFeedbackFlow==2) {
    baseidFeedback();
  }
