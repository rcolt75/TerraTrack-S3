...
int ddsm_posl=0;
int ddsm_posr=0;
int ddsm_last_posl=0;
int ddsm_last_posr=0;

int ddsm_total = 6;
int ddsm_ctrl_num = 1;
unsigned long ddsm_last_time = millis();

// #define THRESHOLD_PWM 23
// mainType:01 Cobra_Surge
// #define WHEEL_D 0.0997
// #define TRACK_WIDTH	0.194


// mainType:02 Cobra_Flex
// #define WHEEL_D 0.0739
// #define TRACK_WIDTH	0.159


double WHEEL_D = 0.0739;
int ONE_CIRCLE_PLUSES = 32767;
